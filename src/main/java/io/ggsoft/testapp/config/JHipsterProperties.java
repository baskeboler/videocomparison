package io.ggsoft.testapp.config;
...
public class JHipsterProperties {
    ...
    public static class Mail {
        ...
        private String from = "testapp@localhost";
    ...
    public static class Swagger {
        ...
        private String title = "testapp API";

        private String description = "testapp API documentation";
