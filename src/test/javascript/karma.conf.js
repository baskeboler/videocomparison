...
module.exports = function (config) {
    config.set({
        ...
        files: [
            ...
            'src/main/webapp/bower_components/videogular/videogular.js',
            'src/main/webapp/bower_components/videogular-controls/vg-controls.js',
            'src/main/webapp/bower_components/videogular-buffering/vg-buffering.js',
